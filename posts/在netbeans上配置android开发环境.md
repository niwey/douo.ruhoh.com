...
date: '2010-05-22'
layout: post
meta: {_aioseop_description: 安装与设置NBAndroid，在netbeans上查看Android源码（Attach Sources）,
  _aioseop_keywords: "NBAndroid,netbeans 7.1,netbeans,Android,æ\x9F¥ç\x9C\x8BAndroidæº\x90\
    ç \x81,Attach Sources", _aioseop_title: 在Netbeans上配置Android开发环境, _edit_last: '1',
  dsq_thread_id: '796842468'}
published: true
status: publish
tags: [Android, NBAdroid, Netbeans]
